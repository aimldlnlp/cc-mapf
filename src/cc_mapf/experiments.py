...
def persist_result(
    ...
    *,
    ...
    record = {
        ...
        "reference_portfolio_source": result.metadata.get("reference_portfolio_source", ""),
        "reference_budget_s": float(result.metadata.get("reference_budget_s", 0.0)),
        "reference_attempt_sequence": list(result.metadata.get("reference_attempt_sequence", [])),
        "reference_rebuilds": int(result.metadata.get("reference_rebuilds", 0)),
        "reference_execution_policy": str(result.metadata.get("reference_execution_policy", "")),
        ...
        "window_mode": str(result.metadata.get("window_mode", "")),
        "window_failures": int(result.metadata.get("window_failures", 0)),
        "reference_prefix_steps": int(result.metadata.get("reference_prefix_steps", 0)),
        "local_success_windows": int(result.metadata.get("local_success_windows", 0)),
        "fallback_windows": int(result.metadata.get("fallback_windows", 0)),
        "fallback_progress_resets": int(result.metadata.get("fallback_progress_resets", 0)),
        "guide_bridge_attempts": int(result.metadata.get("guide_bridge_attempts", 0)),
        "guide_bridge_successes": int(result.metadata.get("guide_bridge_successes", 0)),
        "guide_bridge_max_offset": int(result.metadata.get("guide_bridge_max_offset", 0)),
        "guide_bridge_progress_resets": int(result.metadata.get("guide_bridge_progress_resets", 0)),
        "guide_frontier_shrinks": int(result.metadata.get("guide_frontier_shrinks", 0)),
        "guide_abandonments": int(result.metadata.get("guide_abandonments", 0)),
        "executable_recovery_attempts": int(result.metadata.get("executable_recovery_attempts", 0)),
        "executable_recovery_successes": int(result.metadata.get("executable_recovery_successes", 0)),
        "executable_recovery_source": str(result.metadata.get("executable_recovery_source", "")),
        "stall_recovery_uses": int(result.metadata.get("stall_recovery_uses", 0)),
        "fallback_progress_mode": str(result.metadata.get("fallback_progress_mode", "")),
